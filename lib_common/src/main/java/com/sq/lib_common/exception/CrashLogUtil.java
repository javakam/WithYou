...
public class CrashLogUtil {
    ...
    private static final String ERROR_CACHE_DIR="/storage/emulated/0/CaijiPlatfort/crash/";
    ...
    private static void dumpPhoneInfo(PrintWriter pw) {
        ...
        try {
            PackageInfo packageInfo = packageManager.getPackageInfo(BaseApplication.getApp().getPackageName()
